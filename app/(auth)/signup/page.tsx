...
export default function Signup() {
    return (
        <main>
            ...
            <p className="font-sofiaPro text-lg mt-4">Already have an account?</p>
            <div className="mx-auto flex justify-center mb-8 scale-75">
                <div className="relative group flex justify-end items-center text-darkBlue">
                    <Link className="transition-all duration-300 ease-in-out group-hover:pr-6" href="/login">Login</Link>
